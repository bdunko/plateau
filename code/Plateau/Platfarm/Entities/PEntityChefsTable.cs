...
namespace Platfarm.Entities
{
    public class PEntityChefsTable : PlacedEntity, IInteract, IHaveHoveringInterface
    {
        ...
        public PEntityChefsTable(PartialRecolorSprite sprite, Vector2 tilePosition, PlaceableItem sourceItem, DrawLayer drawLayer) : base(tilePosition, sourceItem, drawLayer)
        {
